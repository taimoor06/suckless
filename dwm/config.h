...
//#include "/home/taimoor/.cache/wal/colors-wal-dwm.h"
...
static const char *fonts[]          = { "Cousine Nerd Font:size=11", "JoyPixels:style=Regular:pixelsize=14:antialias=true:autohint=true"  };
...
const char *spcmd2[] = {"st", "-n", "spfm", "-g", "90x25", "-e", "ncmpcpp", NULL };
const char *spcmd3[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
const char *spcmd4[] = {"st", "-n", "spt", "-g", "90x25", NULL };
...
static const char *dmenucmd[] = { "dmenu_run", "-l", "10", "-c", "-bw", "2", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,   XK_b, 		spawn, SHCMD("bookmarkthis") },
        { Mod1Mask, 		XK_w, 		spawn, SHCMD("setbg ~/.local/walls/") },

	{ MODKEY|ShiftMask,	XK_s, 		spawn, SHCMD("dm-song") },
	{ MODKEY,		XK_r, 		spawn, SHCMD("dm-dox")},
	{ MODKEY|ShiftMask, 	XK_w, 		spawn, SHCMD("dm-wiki") },
	{ MODKEY|ShiftMask, 	XK_x, 		spawn, SHCMD("dm-shutdown") },
	{ MODKEY,		XK_Print,  	spawn, SHCMD("maimpick")},
	{ MODKEY,	   	XK_Insert, 	spawn, SHCMD("dm-bm") },
	{ MODKEY,	    	XK_w, 		spawn, SHCMD("dm-search") },
	{ MODKEY,	    	XK_semicolon,   spawn, SHCMD("dm-web") },
	{ MODKEY|ShiftMask, 	XK_e, 		spawn, SHCMD("dm-emoji") },
	{ MODKEY, 	    	XK_y, 		spawn, SHCMD("dm-yt") },
	{ MODKEY|ShiftMask,   	XK_y, 		spawn, SHCMD("dm-ytmusic") },
	{ MODKEY,  XK_n, spawn, {.v = (const char*[]){ TERMINAL, "-e", "nvim", "-c", "VimwikiIndex", NULL } } },
	{ MODKEY|ShiftMask, XK_d, 
		spawn, {.v = (const char*[]){ TERMINAL, "-e", "nvim", "-c", "VimwikiDiaryIndex", NULL } } },
	...
	{ MODKEY,			XK_F3,	   spawn,		SHCMD("mailsync") },
	{ MODKEY,			XK_F2,	   spawn,		SHCMD("vpn") },
